...
contextBridge.exposeInMainWorld('api', {
  ...
  startUpdateInstall: () => ipcRenderer.invoke(IPC.START_UPDATE_INSTALL),
  getAppVersion: () => ipcRenderer.invoke(IPC.GET_APP_VERSION),
  openExternal: (url: string) => ipcRenderer.invoke(IPC.OPEN_EXTERNAL, url),
  getAutoCheckForUpdates: () => ipcRenderer.invoke(IPC.GET_AUTO_CHECK_FOR_UPDATES),
  setAutoCheckForUpdates: (enabled: boolean) => ipcRenderer.invoke(IPC.SET_AUTO_CHECK_FOR_UPDATES, enabled),
