  ...
  return (
    ...
    >
      <m.a
        ...
        className="inline-flex items-center gap-2 h-7 px-3 rounded-full border border-border/60 bg-card/60 backdrop-blur text-xs text-muted-foreground hover:text-foreground hover:border-border transition-colors"
      >
      ...
      >
        A tiny menu bar app that captures any region of your screen and creates
        Linear issues, without leaving your flow.
      </m.p>
